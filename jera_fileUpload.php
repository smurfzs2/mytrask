        ...
        <form action="jera_upload.php" method="post" enctype="multipart/form-data">
            <div class="row" style="padding: 20px;">
                ...
                <div class="col-md-6 step" id="step1">
                    <div class="">
                        <h4 for="" style="margin-bottom: 2rem;"><b><?php echo displayText('L3836', 'utf8', 0, 0, 1); ?></b></h4>
    ...
    function populateTable(data, tableBody) {
        ...
        data.forEach(function(item) {
            var row = '<tr><td>' +
                ...
                '</td><td><button class="btn btn-secondary" disabled id="linkBtn" onclick="submitFormWithParams(\'' + item.cparId + '\', \'' + item.lotNumber + '\')"><?php echo displayText('L4051', 'utf8', 0, 0, 1); ?></button></td></tr>';
